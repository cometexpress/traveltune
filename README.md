...
|  지도 상세 UI |  6  |  6  |  - h | <ul><li>[ ] </li></ul> | - |
|  지도 상세 마커, 클러스터링 터치 기능 |  6  |  10  |  - h | <ul><li>[ ] </li></ul> | - |
|  설정 메인 UI  |  7  |  8  | - h | <ul><li>[ ] </li></ul> | - |
|  설정 메인 기능  |  7  |  기획부재  | - h | <ul><li>[ ] </li></ul> | - |
|  로컬 알림 기능  |  7  |  3  |  - h | <ul><li>[ ] </li></ul> | - |
|  LiveActivity 기능  |  7  |  6  |  - h | <ul><li>[ ] </li></ul> | - |
|  미구현된 기능 완료  |  7  | -  |  - h | <ul><li>[ ] </li></ul> | - |
